...
Scenario('searching movies',
  async ({ I }) => {
    ...
    for (const title of matchingMovies) {
      const index = matchingMovies.indexOf(title);
      const visibleTitle = await I.grabTextFrom(locate('.movie__title')
        .at(index + 1));
